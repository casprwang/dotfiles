...
# --color=bg+:#CBD9E3,border:#2C363C,spinner:#944927,hl:#A8334C,fg:#2C363C,header:#A8334C,info:#88507D,pointer:#944927,marker:#944927,fg+:#2C363C,prompt:#88507D,hl+:#A8334C"

# alias f='fzf --height 40% --layout reverse --border -m --bind "enter:become(nvim {+})"'
